      ...
      <MainLayout>
        <div>
          <div className="container flex flex-col items-center gap-[48px]">
            <div className="mx-[114px] mt-[152px] flex flex-row justify-center gap-[72px] md:mx-[24px]">
              <Image
                src={"/America.png"}
                alt="Countries"
                width={888}
                height={420}
                className="shadow-left h-full max-h-[420px] w-[888px] rounded-[36px] border-2 border-[#001427] object-cover md:max-h-[158px]"
              />
            </div>
          </div>
